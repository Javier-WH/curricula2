...
export default function Portfolio() {
    ...
    return <a href="http://franciscowh.free.nf" id="Portfolio-button" className="button-53">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-journal-code" viewBox="0 0 16 16" id="portfolio-icon">
