    ...
    return <div id="body-container">
        ...
        <section className="cristal">
            ...
            <ul>
                ...
                <li>
                    Altagracia de Orituco, Edo Guarico, Venezuela
                </li>
                <li>
                    GPA: 3,81
                </li>
        ...
        <section className="cristal">
            ...
            <ul>
                ...
                <ol>
                    ...
                    <li>
                        Frontend: una página web creada con React, desde la cual los profesores podían subir las calificaciones de los estudiantes.
                    </li>
                    <li>
                        Backend: una API en Node.js y Express para manejar las solicitudes del frontend, junto con una base de datos en PostgreSQL.
                    </li>
                    <li>
        ...
        <section className="cristal">
            ...
            <ul>
                ...
                <li>
                    ICurso de Fundamentos de Ingeniería de Software, Platzi
                </li>
                <li>
                    Curso de diseño responsivo, Platzi
                </li>
                <li>
                    Curso de estructuras de datos y algoritmos, Udemy
                </li>
                <li>
                    Estructura de código de C#, Microsoft
                </li>
                <li>
